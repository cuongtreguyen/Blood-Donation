...
import { Form, Input, Select, DatePicker, Button, Checkbox, Radio, Card, Row, Col, Spin } from 'antd';
...
function BloodRequestForm() {
  ...
  const handleCancel = () => {
    const confirmCancel = window.confirm('Bạn có chắc chắn muốn hủy yêu cầu này?');
    if (confirmCancel) {
      ...
      <Card title="Đăng Ký Nhận Máu" className="shadow-md">
        ...
        >
          ...
          <div className="bg-gray-50 p-4 mb-4 rounded-md border border-gray-200">
            <h3 className="font-semibold text-lg mb-3 text-red-700">Thông tin cá nhân</h3>
            ...
            <Row gutter={16}>
              <Col xs={24} md={16}>
                ...
                >
                  <Input prefix={<EnvironmentOutlined />} placeholder="Địa chỉ liên hệ" />
                </Form.Item>
              </Col>
          ...
          {/* Thông tin y tế */}
          <div className="bg-gray-50 p-4 mb-4 rounded-md border border-gray-200">
            <h3 className="font-semibold text-lg mb-3 text-red-700">Thông tin y tế</h3>
            ...
            <Row gutter={16}>
              ...
              <Col xs={24} md={8}>
                ...
                >
                  <Input type="number" placeholder="Cân nặng" min={0} max={200} />
                </Form.Item>
              </Col>
              ...
              <Col xs={24} md={8}>
                <Form.Item
                  ...
                  label="Chiều cao (cm)"
                >
                  <Input type="number" placeholder="Chiều cao" min={0} max={250} />
                </Form.Item>
              </Col>
            </Row>
            
            <Form.Item name="medical_history" label="Tiền sử bệnh">
              <TextArea placeholder="Mô tả các bệnh lý hiện tại hoặc trước đây (nếu có)" rows={3} />
            </Form.Item>
          ...
          <div className="bg-gray-50 p-4 mb-4 rounded-md border border-gray-200">
            <h3 className="font-semibold text-lg mb-3 text-red-700">Thời gian và địa điểm nhận máu</h3>
              ...
              <Col xs={24} md={8}>
                ...
                >
                  <Select placeholder="Chọn địa điểm">
                    ...
                    <Option value="hospital_2">Bệnh viện Đa khoa Sài Gòn</Option>
                    <Option value="hospital_3">Bệnh viện Thống Nhất</Option>
                    <Option value="hospital_4">Viện Huyết học Truyền máu TW</Option>
                  </Select>
                </Form.Item>
              </Col>
            </Row>
          ...
          <div className="bg-gray-50 p-4 mb-4 rounded-md border border-gray-200">
            <h3 className="font-semibold text-lg mb-3 text-red-700">Liên hệ khẩn cấp</h3>
          ...
          <Form.Item
            ...
            rules={[
              {
                validator: (_, value) =>
                  value ? Promise.resolve() : Promise.reject(new Error('Vui lòng đồng ý với các điều khoản')),
              },
            ]}
          >
            <Checkbox>
