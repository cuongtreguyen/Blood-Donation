...
// /* -------------------------------------------------------------------------- */
// /*  PasswordResetForm.jsx – Forgot‑Password → Verify‑OTP → Reset‑Password     */
// /* -------------------------------------------------------------------------- */
...
//       <p className="text-center text-sm text-red-700 mb-2">Nhập mã OTP</p>
...
//             maxLength={1}
//             className="w-12 h-12 text-center border-2 rounded focus:ring-red-500"
//             value={v}
...
//         ) : (
//           <button className="text-red-600 font-medium" onClick={resend}>
//             Gửi lại OTP
//           </button>
//         )}
//       </div>
...
//       {/* background trái tim bay nho nhỏ */}
//       <div className="absolute inset-0 pointer-events-none">
//         {Array.from({ length: 14 }).map((_, i) => (
//           <Heart
//             key={i}
//             className="absolute text-red-800 animate-pulse"
//             style={{
//               fontSize: `${Math.random() * 50 + 25}px`,
//               left: `${Math.random() * 100}%`,
//               top: `${Math.random() * 100}%`,
...
//       <div className="relative z-10 w-full max-w-md bg-white/90 backdrop-blur p-8 rounded-xl shadow space-y-6">
//         <div className="text-center">
//           <Heart className="mx-auto h-12 w-12 text-red-800" />
//           <h2 className="mt-4 text-2xl font-extrabold text-red-900">
...
//                 </button>
//               </div>
//               {errs.pwd && <p className="text-sm text-red-600">{errs.pwd}</p>}
//             </div>
...
//                 </button>
//               </div>
//               {errs.cfm && <p className="text-sm text-red-600">{errs.cfm}</p>}
//             </div>
