...
const EditForm = ({ appointment, onSubmit, onCancel, isLoading, userData }) => {
  ...
  // Reset form khi appointment thay đổi
  useEffect(() => {
    reset({
      wantedDate: appointment.wantedDate || "",
      wantedHour: appointment.wantedHour || "",
...
const AppointmentManager = () => {
  ...
  const onSubmitEdit = async (data) => {
    console.log("Data received in onSubmitEdit:", data);
  ...
  if (isLoading && appointments.length === 0) {
    return (
      <div className="min-h-screenbg-gradient-to-br from-red-50 via-white to-red-100 p-4 sm:p-6 lg:p-10 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-red-600 mx-auto mb-4"></div>
          <p className="text-gray-600">Đang tải dữ liệu...</p>
        </div>
